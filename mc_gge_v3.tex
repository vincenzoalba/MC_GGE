...
scenario is far less clear (see Ref.~\onlinecite{fagotti-2014} for some results in an 
...
has been already explored in Ref.~\onlinecite{gu-2005} for the Gibbs ensemble.
...
the conserved charges (see Re.~\onlinecite{grabowski-1995} for the $XXX$ chain), whereas 
